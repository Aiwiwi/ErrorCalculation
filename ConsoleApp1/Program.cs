...
namespace ConsoleApp
{
    class Program
    {
        ...
        static void Borders_Method(Single[] ResultsX1, Single[] ResultsX2, float DivVal, float DeviceErr, float DivVal2, float DeviceErr2, string function)//Метод границ
        {
            ...
            if (true)//для первой велечины
            {
                ...
                float AbsoluteError = RandomMaxError + DivVal / 2 + DeviceErr;
            ...
            if (true)//ВТОРАЯ ВЕЛИЧИНЫ
            {
                ...
                RandomMaxError = AverageRandomError * kef;
                float AbsoluteError = RandomMaxError + DeviceErr2 + DivVal2 / 2;
            ...
            Console.WriteLine($"Значение измеряемой величины - {Ymeansurements}\t\nАбсолютная погрешность - {DeltaY}");
        ...
        static void SquareBeq0(float[] ResultsX, float[] ResultsY, float DivVal, float DevErr)
        {
            ...
            {
                Console.WriteLine("Выберите способ, для вычесления погрешности:\t\n1.метод наименьших квадратов\t\n2.метод границ\t\n3.метод прямых измерений");
                ...
                if (method == '1')//метод наименьших квадратов
                {
                    ...
                    if (str == "Да" || str == "да" || str == " Да" || str == " да" || str == "да " || str == "Да " || str == " Да " || str == " да ")
                    {
                        ...
                        Console.WriteLine("Введите количество измерений величины Y (y = ax+b)");
                        ...
                        Console.WriteLine("Введите количество измерений величины X (y = ax+b)");
                        int quantityX = int.Parse(Console.ReadLine());

                        float[] ResultsX = new float[quantityX];
                ...
                else if (method == '2')//метод границ
                {
                    ...
                    if (func == "1" || func == "2" || func == "3" || func == "4")
                    {
                        ...
                        Borders_Method(FirstResults, SecondResults, DivisionValue, DeviceError, DivisionValue2, DeviceError2, func);
                    }
                ...
                else if (method == '3')//метод прямых измерений
                {
                    ...
                    Straight_Meansurements_Method(quantity_of_measurements, measurement, div_val, device_error);
                }
